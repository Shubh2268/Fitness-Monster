...
const ExerciseCard = ({ exercise }) => {
    return (
        <Link to={`/exercise/${exercise.id}`} className='w-[230px] h-[240px] md:w-[400px] md:h-[445px] border-t-2 md:border-t-4 border-slate-800 flex justify-between flex-col mx-0 md:mx-10 my-12'>
