...
const Home = () => {
  return (
    <div className='flex items-center px-10 py-10 bg-slate-800'>
      <div className='w-1/2'>
        ...
        <button className='bg-red-500 hover:bg-red-600 mx-4 mt-6 px-6 py-3 text-xl font-semibold italic text-white capitalize rounded-md'>join club</button>
      </div>
